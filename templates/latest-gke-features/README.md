...
- Includes Kubernetes manifests for the workload (`config-connector/workload.yaml`) to demonstrate functional parity for users who prefer not to use Helm.
...
kubectl delete -f config-connector/workload.yaml
