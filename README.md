...
| [gke-inference-fuse-cache](templates/gke-inference-fuse-cache/) | GKE Standard + GCS FUSE Cache + L4 GPUs | GKE Standard + GCS FUSE Cache + L4 GPUs | — |
| [gke-kuberay-kueue-multitenant](templates/gke-kuberay-kueue-multitenant/) | GKE Standard + KubeRay + Kueue + L4 GPUs | GKE Standard + KubeRay + Kueue + L4 GPUs | — |
